...
<div class="site-container">
    ...
    <header class="author-header">
        ...
        <div class="author-avatar">
            ...
            <?php
            $author_profile_image = ssi_fanzine_get_author_profile_picture_url( $author_id, 'medium' );

            if ( $author_profile_image ) :
                ?>
                <img
                    src="<?php echo esc_url( $author_profile_image ); ?>"
                ...
                >
            <?php else : ?>
                <?php echo ssi_fanzine_author_avatar_html( $author_id, 120, 'ssi-author-avatar' ); ?>
            <?php endif; ?>
